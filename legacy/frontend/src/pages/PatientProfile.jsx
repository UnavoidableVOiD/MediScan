...
const Field = ({
  ...
  <div className="space-y-1.5 px-4 py-3 rounded-2xl transition-all duration-300">
    ...
    <div className="flex items-center gap-4 group">
      <div
        className={`p-2 rounded-xl transition-all duration-300 ${isEditing && !disabled ? "bg-medic-dark/10 text-medic-dark" : "bg-gray-50 text-gray-400 group-hover:text-gray-600"}`}
      >
      ...
      {isEditing && !disabled ? (
        ...
        <span
          className={`flex-grow font-medium py-1 ${disabled ? "text-gray-400" : "text-gray-900"}`}
        >
          {value || "Not provided"}
        </span>
      )}
...
const PatientProfile = () => {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      console.error(error);
      const errorMsg = error.phone_number
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 pt-32 pb-12">
      <header className="mb-10 flex flex-col sm:flex-row sm:items-end justify-between gap-6">
        <div>
          <h1 className="text-4xl font-bold text-medic-dark mb-2 tracking-tight">
            Your Profile
          </h1>
        ...
        <div className="pt-20 pb-10 px-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <h3 className="text-xl font-bold text-gray-900 border-l-4 border-medic-dark pl-4 mb-6">
                Personal Details
              </h3>
              <div className="grid grid-cols-1 gap-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <Field
                    ...
                    icon={User}
                    disabled={true}
                    isEditing={isEditing} // show as input-like but disabled
                  />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6 md:border-l md:border-gray-100 md:pl-10">
              <h3 className="text-xl font-bold text-gray-900 border-l-4 border-medic-light pl-4 mb-6">
              ...
              <div className="mt-10 p-5 bg-medic-light/10 rounded-2xl border border-medic-light/20 flex items-start gap-4">
                ...
                <div className="text-xs text-medic-dark/70 leading-relaxed">
                  ...
                  Your email and account role are verified identifiers and
                  cannot be changed. For account recovery support, please
                  contact help@mediscan.com.
                </div>
              </div>
            </div>
          </div>
