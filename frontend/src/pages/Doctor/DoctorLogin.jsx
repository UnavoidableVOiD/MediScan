        ...
        <div className="flex justify-center gap-3">
          {!isIOS() && (
            <button
              ...
              className="flex items-center justify-center w-14 h-14 border border-slate-200 rounded-xl hover:bg-slate-50 transition shadow-sm"
        ...
        <div className="flex justify-center gap-3 mt-6">
          {!isIOS() && (
            <button
              ...
              title="Sign in with Google"
            >
              <i className="fa-brands fa-google text-red-500 text-3xl"></i>
            </button>
          )}
