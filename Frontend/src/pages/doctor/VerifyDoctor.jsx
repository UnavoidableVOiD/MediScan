...
const VerifyDoctor = () => {
  ...
  const validateForm = () => {
    const newErrors = {};
    if (!nmcNumber.trim())
      newErrors.nmcNumber = "NMC License Number is required";
        ...
        >
          <div className="bg-medic-dark p-8 md:p-10 text-white flex items-center justify-between">
            <div className="space-y-1">
              ...
              <p className="text-medic-light/70 text-sm md:text-base">
                Provide your credentials to unlock all platform features.
              </p>
            </div>
          ...
          <form onSubmit={handleSubmit} className="p-8 md:p-10 space-y-10">
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-6 py-4 bg-neutral-soft border-2 rounded-2xl outline-none transition-all font-bold text-gray-900 placeholder:text-gray-400 ${
                    errors.nmcNumber
                      ? "border-red-500"
                      : "border-transparent focus:border-medic-dark focus:bg-white focus:shadow-xl focus:shadow-medic-dark/5"
                  }`}
                />
                {errors.nmcNumber && (
            ...
            <div className="space-y-4">
              ...
              {!licenseImage ? (
                <div
                  ...
                  className={`group cursor-pointer border-2 border-dashed rounded-3xl p-10 flex flex-col items-center justify-center gap-4 transition-all hover:bg-medic-light/10 ${
                    errors.licenseImage
                      ? "border-red-500"
                      : "border-gray-200 hover:border-medic-dark"
                  }`}
                >
            ...
            <div className="space-y-4 pt-4 border-t border-gray-100">
              ...
              {supportingDocs.length > 0 ? (
                ...
                <p className="text-xs text-gray-400 italic">
                  Degree certificates, ID, or hospital affiliation letters help
            ...
            <div className="pt-6">
              ...
              <p className="text-[10px] text-gray-400 text-center mt-4">
                By submitting, you agree to our terms regarding professional
